...
#pragma region 辅助函数
	...
	// 摘要:
	//     构造函数。
	ruleset_def(string value1, string value2, string value3, string value4, string value5, string value6, string value7, string value8, string value9, int value10, string value11, string value12, int value13, string value14);
	//
	// 摘要:
	//     析构函数。
	~ruleset_def();
