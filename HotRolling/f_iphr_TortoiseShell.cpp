...
double TortoiseShell::computekpi()
{
	...
	//Log::Trace("", __FUNCTION__, "flowrateall=[{0}]，actualflow.size()=[{1}]", flowrateall, (int)actualflow.size());
	//Log::Trace("", __FUNCTION__, "assigned_wt=[{0}]，allsteelcCoil_wt=[{1}]", assigned_wt, allsteelcCoil_wt);
	//Log::Trace("", __FUNCTION__, "rollingkm=[{0}]，s_mapSetOfTortoiseShell.size()=[{1}]，max_TortoiseShell_len=[{2}]", rollingkm, (int)s_mapSetOfTortoiseShell.size(), max_TortoiseShell_len);
	//Log::Trace("", __FUNCTION__, "assigned_DHCR=[{0}]，j=[{1}]", assigned_DHCR, j);
	//Log::Trace("", __FUNCTION__, "all_penalty=[{0}]，Scheduling_quality_deno=[{1}]", all_penalty, Scheduling_quality_deno);
